    ...
    return (
        <div className='h-[calc(100vh-23ch)] flex items-center justify-center'>
            <div className='bg-neutral-200/30 shadow-lg rounded-2xl p-10 w-96'>
                <h2 className='text-center text-2xl font-bold text-red-500 mb-6'>Sign In</h2>
                <form className='flex flex-col gap-y-4' onSubmit={submit}> {/* Apply onSubmit to the form */}
                    ...
                    {/* Username field */}
                    <div className='flex flex-col'>
                        <label htmlFor='username' className='text-red-500 font-semibold mb-1'>Username:</label>
                        <input
                            type='text'
                            id='username'
