...
import {
  useFoodOrderPlaced,
  useGetFoodById,
} from "./actions/foodById.action.config";
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
            ...
            <div className="space-y-4">
              {role !== "admin" && (
                <Button
                  className="w-full bg-black text-white py-3.5 rounded-2xl font-semibold text-base hover:bg-gray-800 transition duration-200 hover:scale-[1.02]"
                  onClick={() => {
